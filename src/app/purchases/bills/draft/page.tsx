  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Draft Bills</h1>
          ...
          <tbody className="divide-y divide-gray-200">
            {draftBillsData.map((bill) => (
              <tr key={bill.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-900">{bill.lineItems}</td>
                <td className="px-6 py-4 text-sm text-gray-600">{bill.createdDate}</td>
