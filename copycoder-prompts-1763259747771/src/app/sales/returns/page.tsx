          ...
          <tbody className="divide-y divide-gray-200">
            {returnsData.map((ret) => (
              <tr key={ret.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm font-medium text-gray-900">{ret.invoiceNumber}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{ret.customerName}</td>
                <td className="px-6 py-4 text-sm font-medium text-red-600">{ret.returnAmount}</td>
