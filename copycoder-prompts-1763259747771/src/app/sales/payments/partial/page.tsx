  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Partial Payments</h1>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-gray-100 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">Invoice Amount</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {partialPaymentsData.map((payment) => (
              <tr key={payment.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-blue-600">{payment.invoiceNumber}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{payment.customerName}</td>
                <td className="px-6 py-4 text-sm font-medium text-gray-900">{payment.invoiceAmount}</td>
                ...
                <td className="px-6 py-4 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-24 bg-gray-200 rounded-full h-2">
                      <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${payment.percentagePaid}%` }}></div>
                    </div>
